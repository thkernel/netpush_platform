...
class ProductCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_category" do
    assert_difference('ProductCategory.count') do
      post product_categories_url, params: { product_category: { description: @product_category.description, name: @product_category.name, status: @product_category.status, user_id: @product_category.user_id } }
    end
  ...
  test "should update product_category" do
    patch product_category_url(@product_category), params: { product_category: { description: @product_category.description, name: @product_category.name, status: @product_category.status, user_id: @product_category.user_id } }
