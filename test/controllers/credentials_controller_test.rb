...
class CredentialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credential" do
    assert_difference('Credential.count') do
      post credentials_url, params: { credential: { active: @credential.active, api_key: @credential.api_key, api_secret: @credential.api_secret, user_id: @credential.user_id } }
    end
  ...
  test "should update credential" do
    patch credential_url(@credential), params: { credential: { active: @credential.active, api_key: @credential.api_key, api_secret: @credential.api_secret, user_id: @credential.user_id } }
