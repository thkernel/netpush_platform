...
class ContactsTest < ApplicationSystemTestCase
  ...
  test "creating a Contact" do
    ...
    fill_in "Contact book", with: @contact.contact_book_id
    fill_in "Country", with: @contact.country
    fill_in "Email", with: @contact.email
    fill_in "First name", with: @contact.first_name
    fill_in "Gender", with: @contact.gender
    fill_in "Last name", with: @contact.last_name
    fill_in "Main phone number", with: @contact.main_phone_number
    fill_in "Notes", with: @contact.notes
    fill_in "Slug", with: @contact.slug
